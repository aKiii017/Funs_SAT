...
def print_function_info(func_node, source_file_path) -> Optional[Function]:
    # Ensure the function is defined in the source file we are interested in
    ...
    # Extracting function body and potentially a docstring
...
def get_function_body(func_node):
    ...
    with open(start_token.file.name, 'r') as file:
        ...
        if start_offset != -1 and end_offset != -1:
            ...
            # return file_content[start_offset+1:end_offset]#不包括大括号
        else:
            return ""

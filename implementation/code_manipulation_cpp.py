...
def text_to_program(code: str) -> Program:
    ...
    # include_paths = ["/home/ubuntu/Fun_SAT/implementation"]
    # include_paths = ["/home/ubuntu/Fun_SAT/implementation/z3/src"]
    include_paths = conf['include_paths']
